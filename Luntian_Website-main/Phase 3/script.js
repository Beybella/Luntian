    ...
    document.querySelectorAll(".product-card .btn").forEach(button => {
        button.addEventListener("click", function () {
            ...
            modalMessage.innerHTML = `<strong>${name}</strong> has been added to your cart! <br>
                    <a href="cart.php" style="color: var(--olive); text-decoration: underline;">View Cart</a> or continue shopping.`;
...
if (checkoutBtn) {
    checkoutBtn.addEventListener('click', () => {
        ...
        window.location.href = `contact.php?message=${encodeURIComponent(message)}`;
    });
}
